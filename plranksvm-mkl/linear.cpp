...
void selection_rank_fun::Xv(double *v, double *Xv)
{
	...
	double alpha = 1.0;
	double beta = 0.0;
	mkl_dcsrmv("N", &(prob->l), &(prob->n), &alpha, "GXXC", sparX, indx, pntrb, pntre, v, &beta, Xv);
}
...
void selection_rank_fun::XTv(double *v, double *XTv)
{
	...
	double alpha = 1.0;
	double beta = 0.0;
	mkl_dcsrmv("T", &(prob->l), &(prob->n), &alpha, "GXXC", sparX, indx, pntrb, pntre, v, &beta, XTv);
}
